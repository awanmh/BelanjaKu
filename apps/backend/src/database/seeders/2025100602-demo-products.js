...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    /* ===================== USERS ===================== */
    // ===== ADMIN =====
    const adminEmail = 'admin@belanjaku.com';
    let adminId = await queryInterface.rawSelect(
      'users',
    ...
    // ===== SELLER =====
    const sellerEmail = 'seller@toko.com';
    let sellerId = await queryInterface.rawSelect(
      'users',
    ...
    let fashionId = await queryInterface.rawSelect(
      'categories',
