      ...
      items: [
        {
          ...
          image:
            "https://images.unsplash.com/photo-1560769629-975e13f0c470?q=80&w=200",
        },
        {
          name: "Ventela Ethnic Low Black",
          image:
            "https://images.unsplash.com/photo-1600185365926-3a2ce3cdb9eb?q=80&w=200",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          image:
            "https://images.unsplash.com/photo-1491553895911-0055eca6402d?q=80&w=200",
        },
      ],
    },
  ];
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
              <div className="p-6 border-b border-gray-100 text-center">
                <div className="w-20 h-20 bg-gray-200 rounded-full mx-auto mb-3 overflow-hidden">
                  <img
                    src="https://ui-avatars.com/api/?name=John+Doe&background=000&color=fff"
                    alt="Profile"
                ...
                {orders.map((order) => (
                  ...
                  >
                    ...
                    <div className="mt-6 flex justify-end">
                      <Button
                        variant="outline"
                        className="text-xs uppercase tracking-widest font-bold border-black text-black hover:bg-black hover:text-white"
                      >
                        Lihat Detail
                      </Button>
                    </div>
            ...
            {activeTab === "address" && (
              <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <Button className="bg-black text-white text-xs uppercase tracking-widest font-bold">
                    Tambah Alamat
                  </Button>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-4 relative hover:border-black transition-colors">
                  ...
                  <p className="text-sm text-gray-600 max-w-md">
                    Jl. Jendral Sudirman No. 1, Senayan, Kebayoran Baru, Jakarta
                ...
                <form className="space-y-4 max-w-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:border-black outline-none bg-gray-50"
                      disabled
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="pt-4">
                    <Button className="bg-black text-white h-10 px-6 uppercase tracking-widest font-bold text-xs">
                      Simpan Perubahan
                    </Button>
                  </div>
                </form>
